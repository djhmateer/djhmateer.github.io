...
```python
# we don't need to import this module 2.22.0 is there already
# when run inside the virtual environment it is 2.27.1
import requests
import sys
...
pipenv working, but using pythom 3.8.10 to run. 

[![alt text](/assets/2022-03-16/310.jpg "desktop")](/assets/2022-03-16/310.jpg)
Better - using 3.10. I had to downgrade all to 3.9 to get VS Code working below
...
### Getting API access to the sheet
