...
categories: Wordpress Azure AKS Kubernetes 
published: true 
comments: true
...
All websites should use HTTPS now. DNSimple who I use, make it easy to request a LetsEncrypt cert manually, so I'll show this first, and how to wire it up. Manually installing certs is still normal in my day job. I'll show how to get K8s to auto install certs too.
...
- [Bitnami Wordpress Image](https://github.com/bitnami/bitnami-docker-wordpress) - 1m+ pulls
   ...
   - Apache2.4.33
- [Wordpress Image](https://hub.docker.com/_/wordpress) - 10m+ pulls
