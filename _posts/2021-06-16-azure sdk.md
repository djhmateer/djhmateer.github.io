...
- Azure SDK for .NET Preview (2020) - looks good but still in preview
...
[https://github.com/Azure/azure-sdk-for-net/blob/master/doc/mgmt_preview_quickstart.md](https://github.com/Azure/azure-sdk-for-net/blob/master/doc/mgmt_preview_quickstart.md) quickstart tutorial
...
[https://docs.microsoft.com/en-gb/samples/azure-samples/azure-samples-net-management/compute-create-vm/](https://docs.microsoft.com/en-gb/samples/azure-samples/azure-samples-net-management/compute-create-vm/) good samples.


`Azure.ResourceManager`

These libraries are in prerelease

The sample above doesn't work with 

`Azure.ResourceManager.Network (1.0.0-preview.2)`



## Older libraries - dont use
...
`Microsoft.Azure.Management.Fluent` import from NuGet - don't use!!!
