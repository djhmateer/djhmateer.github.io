...
I've never 'done' IoT devices before, having heard lots about [Raspberry Pi's](https://www.raspberrypi.org/) and [Arduino's](https://www.arduino.cc/). I thought my 5 and 3 year olds may be interested in this too.
...
[The specs are here](https://www.element14.com/community/community/designcenter/azure-sphere-starter-kits?ICID=azure-sphereCH-topbanner) and [more specs from the mother company avnet here](https://www.avnet.com/shop/us/products/avnet-engineering-services/aes-ms-mt3620-sk-g-3074457345636825680/?aka_re=1):

[PDF Manual here](https://www.avnet.com/opasdata/d120001/medias/docus/196/Azure%20Sphere%20Starter%20Kit%20User%20Guide%20(v1.3).pdf)  
...
- [Install the SDK for Visual Studio]() which took 15 minutes on my laptop and it seemed to hang, but I suspect it was just a large download happening
...
## Updates
[Azure Updates](https://azure.microsoft.com/en-gb/updates/?product=azure-sphere)
...
## Element 14 non connected demo 1 
...
- Can be used to monitor wildlife eg birds, mammels
- Can be used to transmit data eg [LoRaWAN](https://www.thethingsnetwork.org/)
- Monitor insect experiments eg temperature, humidity, water level, video

I suspect that a [Raspberry Pi 4](https://www.raspberrypi.org/) or an [Arduino](https://www.arduino.cc/) will be interesting to research, which have much larger ecosystems.
