...
### Data Table / Databgrid

Lets look at a grid and data flow next
sort filter etc..
...
using shadcn make a forms over data crud app - ie make a grid editable perhaps with a modal?
or what is the most react esque way of making a form
