...
[https://github.com/NVlabs/ffhq-dataset](https://github.com/NVlabs/ffhq-dataset) is a python script I wanted to get working to download a lot of images:
...
# to install pip into my latest version of python3.9.5
python3.9 -m pip install tweepy
```

`ModuleNotFoundError: No module named 'PIL'` - so lets use pip3 to get them all (should favour apt)

```bash
# image is part of PIL
pip3 install image
pip3 install scipy
...
# the 1024 * 1024 images as png 70k (89.1GB)
python3 download_ffhq.py --images --pydrive

# the wild images 955GB
python3 download_ffhq.py --wilds --pydrive
```
