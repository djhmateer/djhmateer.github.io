...
```bash
# To install or update run the install script

# https://github.com/nvm-sh/nvm
curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.40.3/install.sh | bash

# 0.40.1 on 4th Nov 24
# 0.40.2 on 31st Mar 25
# 0.40.3 on 27th Apr 25
nvm --version

# Node.js (LTS) 22.14.0 on 5th Mar 2025
# 22.15.0 on 27th Apr 25
# https://nodejs.org/en
nvm install --lts
node --version


# 11.3.0 on 27th Apr 25
# **HERE - interestingly my rgb machine didn't ask to be updated and is on  10.9.2**
# https://www.npmjs.com/package/npm
npm install -g npm@11.3.0

# **This worked on rgb to update npm on rgb from 10.9.2 to 11.2.0**
npm install -g npm
...
[![alt text](/assets/2025-03-05/18.jpg "email")](/assets/2025-03-05/18.jpg)

Once submitted, the selected items disappear.. annoying

This workflow seems overly complex. **todo - see if there is a better way**
...
Hmm - this Try Again does seem complex. Nice feature I guess.

[![alt text](/assets/2025-03-05/16.jpg "email"){:width="700px"}](/assets/2025-03-05/16.jpg)

The catch all error handler worked for `/dashboard/invoices` route.

### 404 errors with notFound function

A working UUID: [http://localhost:3000/dashboard/invoices/65e7d2fb-5daa-4308-8ab6-4639bcfbb39f/edit](http://localhost:3000/dashboard/invoices/65e7d2fb-5daa-4308-8ab6-4639bcfbb39f/edit)

[![alt text](/assets/2025-03-05/17.jpg "email"){:width="700px"}](/assets/2025-03-05/17.jpg)

A bogus UUID: [http://localhost:3000/dashboard/invoices/2e94d1ed-d220-449f-9f11-f0bbceed9645/edit](http://localhost:3000/dashboard/invoices/2e94d1ed-d220-449f-9f11-f0bbceed9645/edit)
...
## Ch 14 - Form validation

Client side eg just adding in `required` html tag
...
Gosh - some complexity here hooking into the client side hook. hmmmmm.

And when you get form validation errors, the previous selection is not remembered - annoying
...
We're going to use [NextAuth.js](https://authjs.dev/reference/nextjs) to abstract away session management, sign-in, sign-out. interestingly in package.json we're referencing [5.0.0-beta.25](https://www.npmjs.com/package/next-auth?activeTab=versions) which is the most up to date beta. This is compatible with Next.js 14+.
...
Need to update in prod too in Settings, Environment Variables, Add new Key and Value.
...
then need to protect routes with middleware:
...
[https://authjs.dev/getting-started/providers/credentials](https://authjs.dev/getting-started/providers/credentials)

and the login form action
...
Add logout to the `SideNav` component

```tsx

```

Can't resolve bcrypt in /auth.ts so had to change the import to
...
[![alt text](/assets/2025-03-05/19.jpg "email"){:width="500px"}](/assets/2025-03-05/19.jpg)

- Email: user@nextmail.com
- Password: 123456

This is simply authenticating from the `users` table in Supabase which was seeded with this user.
...
Can put `favicon.ico` and `opengraph-image.png` inside the `/app` folder and Next.js will automatically identify these files and use them.
...
what is the sweet spot for Next.js / React...
ie super fast forms on the client? super fast validation?

simplify! a lot of complexity in form validation,

routing (why is dashboard home db calls being made when Invoice page is being called?) - okay this is in dev where static

put a ton of records in the db - eg invoices to see how it copes.. db connetion issues. timeouts. Also search and pagination.

move vercel to the UK, move supabase to the UK.
...
react.dev documentation excellent
...
he has built a nextjs competitor

## BAR

MERN - Mongo, Espress, React, Node. Client side
probably good for where you've got multiple UI's eg a mobile app and an SPA app

Next.js - Server side.
good for just a single project web app.

NextJS crash course - 4 years old
https://www.youtube.com/watch?v=mTz0GXj8NN0&t=786s

Next.js 14
mongodb
commercial

Next.js 13 - 1 year old
https://www.youtube.com/watch?v=Y6KDk5iyrYE&t=43s

https://www.youtube.com/watch?v=Evd_7kubWOk
22 hour paid course using: Next.js 15, TS, PostgreSQL, Prisma, https://ui.shadcn.com/ component library.
