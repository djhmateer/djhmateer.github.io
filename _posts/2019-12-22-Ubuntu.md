...
Ubuntu on the desktop works pretty well, and for certain things (the terminal!) I prefer it to Windows.

I see the future direction of Microsoft and my own company to be more Linux centric as it is more resource efficient than Windows servers and ASP.NET Core (which is what I do) runs just fine on both.
