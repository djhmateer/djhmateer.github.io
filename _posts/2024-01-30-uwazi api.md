...
When updating the codebase I've had segfaults in the terminal which required a reboot. Perhaps for testing using the `production` branch may be more stable.

Check you've started docker with run start.
