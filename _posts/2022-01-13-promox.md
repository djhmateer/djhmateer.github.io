...
[Promox VE - Virtual Environment](https://www.proxmox.com/en/proxmox-ve) is an open source server management platform for virtualisation which integrates the [KVM - Kernel Virtual Machine](https://www.linux-kvm.org/page/Main_Page) Hypervisor.

[VMWare ESXi](https://www.vmware.com/uk/products/esxi-and-esx.html) is an alternative to Promox VE
...
TODO What happens when I need to do updates from a linked clone?
...
Ideally yes.. want the homelab to be as secure as possible. The firewall allows me to segreate my home newtwork from the 'prod' network.
...
Domain: can use same as Promox host or a new one. I used `pve.dave.home` for Promox. [https://news.ycombinator.com/item?id=29917860](https://news.ycombinator.com/item?id=29917860) discussion here on a better name.
...
Promox: Hardware, CD/DVD, Do not use media
...
# elps the Proxmox host communicate with the VM guest 
...
- shutdown command on promox itself will result in cleaner shutdown on the vm
...
Good to see the right IP address!
...
[Mastering Promox book](https://www.amazon.co.uk/Mastering-Proxmox-virtualized-environments-hypervisor-ebook/dp/B075DBHJ8T/ref=sr_1_1)
